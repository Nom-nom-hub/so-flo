...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 xs:py-24 sm:py-32 w-full">
        <div className="max-w-4xl">
          ...
          <div className={`mb-2 transition-all duration-700 delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white leading-[0.95] tracking-tight">
              PROFESSIONAL
            </h1>
          </div>

          <div className={`mb-2 h-14 xs:h-16 sm:h-20 lg:h-24 xl:h-28 overflow-hidden transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[0.95] tracking-tight text-sky-400 animate-slide-up">
              {words[currentWord]}
            </h1>
          </div>

          <div className={`mb-2 transition-all duration-700 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white/80 leading-[0.95] tracking-tight">
              FOR YOUR
            </h1>
          </div>

          <div className={`mb-8 transition-all duration-700 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[0.95] tracking-tight">
          ...
          <div className={`mb-12 transition-all duration-700 delay-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 max-w-2xl leading-relaxed">
          ...
          <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 mb-10 sm:mb-16 transition-all duration-700 delay-600 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center gap-2 sm:gap-3 bg-sky-500 hover:bg-sky-400 text-white px-6 sm:px-8 py-4 sm:py-5 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg transition-all duration-300 shadow-2xl shadow-sky-500/40 hover:shadow-sky-400/60 hover:-translate-y-1"
            >
            ...
            <a
              href="tel:2394467091"
              className="group inline-flex items-center justify-center gap-2 sm:gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white border-2 border-white/20 hover:border-white/40 px-6 sm:px-8 py-4 sm:py-5 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg transition-all duration-300"
            >
          ...
          <div className={`grid grid-cols-3 gap-4 sm:gap-6 transition-all duration-700 delay-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="text-center">
              <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">100+</p>
              <p className="text-xs sm:text-sm text-gray-400">Projects Done</p>
            </div>
            <div className="text-center">
              <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1">5+</p>
